...
if option1 == "right":
    ...
    if option2 == "wait":
        ...
        if option3 == "blue":
            ...
            print("You chose the room with the trap in it. Game over.")
    else:
        print("You were impatient and dived into the sea and were attacked by wild sharks. Game over :(.")
else:
    print("You chose the wrong path and fell into a ditch. Sorry, game over :( ")
